...
// Thin wrapper component so we can exercise the hook through a render.
...
describe("useProfile", () => {
  ...
  it("renders the profile name after a successful fetch", async () => {
  ...
  it("shows no profile when the thing is not found in the dataset", async () => {
    mockGetSolidDataset.mockResolvedValue({});
